/** Strategic node name → Wikipedia article title. */
...
/**
 * Fetches a thumbnail URL for any named node (SkyTrain station or strategic node)
 * from the Wikipedia REST API. Results are cached in memory.
 */
